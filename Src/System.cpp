...
TD::System::System(const System& other)
{
}
...
bool TD::System::Initialize()
{
	...
	result = pApplication->Initialize(m_hinstance, m_hwnd, screenWidth, screenHeight);
	if(!result)
	{
		return false;
	}
